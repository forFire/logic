...
@Component
public class PolygonFenceService {
	...
	public void handlePet(Position position, Device device,Fence fence) {
		// 判断是否产生围栏报警
		...
		if (fence == null || device.getFenceSwitch() == null || device.getFenceSwitch() == 2)
			return;
