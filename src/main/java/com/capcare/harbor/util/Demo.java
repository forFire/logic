...
public class Demo {
	...
	public void sendAndroidUnicast() throws Exception {
		...
		unicast.setDeviceToken( "AvGXnNwxyNv5s-q-Jls0UvxsM5iwrFG44azJSeRINC7x");
	...
	public void sendAndroidListcast() throws Exception {
		AndroidUnicast unicast = new AndroidUnicast(appkey,appMasterSecret);
		// TODO Set your device token
		unicast.setDeviceToken( "AnttxIm8y9ePCXW82xrwIwEM91FzbkzAAwTNwgdbQdWC");
		unicast.setTicker( "Android unicast ticker");
		unicast.setTitle(  "中文的title");
		unicast.setText(   "zhws 测试 listcast");
		unicast.goAppAfterOpen();
		unicast.setDisplayType(AndroidNotification.DisplayType.NOTIFICATION);
		// TODO Set 'production_mode' to 'false' if it's a test device. 
		// For how to register a test device, please see the developer doc.
...
//		customizedcast.setAlias("my", "123456789");
		customizedcast.setAlias("123456789", "my");
	...
	public static void main(String[] args) throws JSONException {
		...
		//56fe12d267e58e0e7300063f  5247b6da63b120439616458e0a852714
//		Demo demo = new Demo("your appkey", "the app master secret");
		Demo demo = new Demo("56fc8632e0f55aea1f001100", "vf833t1bsghdiagobe8jzwsct7jn3lbd");
		try {
